...
const SECTIONS: { title: string; note?: string; rules: string[] }[] = [
  {
    ...
    rules: [
      ...
      "Tiny-order exception: an order under 2 pallets can ride along on an A vehicle that's already running, but never OPENS a fresh A truck — it goes to the cheapest suitable small van instead (no ₹7.5k 14ft for a 0.6-pallet crumb).",
