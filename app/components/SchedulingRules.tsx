...
const SECTIONS: { title: string; note?: string; rules: string[] }[] = [
  {
    ...
    rules: [
      ...
      "Fill compromise: a vehicle with spare pallet capacity may reach up to ~10 km farther to fill up (distance isn't a cost, an extra vehicle is). A full or small vehicle stays local — nothing crosses the city.",
      ...
      "Max 3 orders per vendor per day — a hard limit, no exceptions. Overflow goes to the “team to assign” bucket.",
      "Route length: a vendor's whole day stays roughly under 100 km. An order that would push a route past that isn't added — it goes to another vendor or the bucket.",
      "Right-sized vehicle: a small isolated order rides a 10ft van rather than tying up a 14ft, unless a 14ft is much nearer or no 10ft is free.",
