...
const SECTIONS: { title: string; note?: string; rules: string[] }[] = [
  {
    ...
    rules: [
      ...
      "Max 3 orders per vendor per day. The ONLY exception: a single stranded order that would otherwise need its own vehicle is tacked onto the nearest vendor with room (a 4th stop) — so a lone order never wastes a whole truck. Any other overflow goes to the “team to assign” bucket.",
