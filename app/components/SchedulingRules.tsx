...
const SECTIONS: { title: string; note?: string; rules: string[] }[] = [
  {
    ...
    rules: [
      ...
      "Overflow choice (B general vs bulk non-general): with 4+ orders left after the A pass, the bulk per-transaction vendor (e.g. Daksh Cargo — 6 transactions / 14 pallets / ₹15k) is PREFERRED for the leftovers; with fewer, a single general B vehicle (₹5–7.5k/day) is cheaper and wins. Distance can still veto — a leftover far from the bulk vendor goes to a nearer B.",
