...
export type NavKey = "dashboard" | "today" | "schedule" | "history" | "vendors" | "feedback" | "escalations" | "usage" | "rules";
...
const ITEMS: { key: NavKey; label: string; href: string; icon: string }[] = [
  ...
  { key: "escalations", label: "Escalations", href: "/?view=escalations", icon: "M12 9v4m0 4h.01M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z" },
  { key: "usage", label: "Team usage", href: "/?view=usage", icon: "M12 8v4l3 2M3 12a9 9 0 1 0 18 0 9 9 0 0 0-18 0z" },
